...
const getPokemonNames = async ([a,b,c,d] = []) => {
    ...
    return [
        {name: p1.data.name.toUpperCase(), id: p1.data.id, types: p1.data.types, species: p1.data.species},
        {name: p2.data.name.toUpperCase(), id: p2.data.id, types: p2.data.types, species: p2.data.species},
        {name: p3.data.name.toUpperCase(), id: p3.data.id, types: p3.data.types, species: p3.data.species},
        {name: p4.data.name.toUpperCase(), id: p4.data.id, types: p4.data.types, species: p4.data.species}
    ]
} 
